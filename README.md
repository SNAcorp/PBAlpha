...
Класс `Log` предоставляет функционал для записи информации о событиях, происходящих в программе, включая данные о времени, состоянии устройств и выполненных операциях.
